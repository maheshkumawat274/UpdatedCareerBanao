...
//         {/* Desktop Navigation */}
//         <nav className="hidden nav-header md:flex space-x-8 font-bold rounded-md bg-gradient-to-r from-[#983fd4] to-[#e46ab3]">
//           {[{ name: "Home", path: "/" },
...
//         <div className="flex space-x-4 text-[#983fd4]">
//           <span className="flex items-center">
//             <a href="tel:+918750092628" className="flex items-center text-sm hover:underline">
//               <FaPhoneAlt className="mr-2" />
//               +91-8750092628
//             </a>
//           </span>
//           <span className="flex items-center">
//             <a href="mailto:info@careerbanao.org" className="flex items-center text-sm hover:underline">
//               <FaEnvelope className="mr-2" />
//               info@careerbanao.org
//             </a>
//           </span>
...
//         {/* Desktop Navigation */}
//         <nav className="hidden nav-header md:flex gap-8 text-[18px]">
//           {[{ name: "Home", path: "/" },
//             { name: "Admission", path: "/admissions/engineering" },
//             { name: "Counselling", path: "/counselling/engineering" },
//             { name: "College Finder", path: "/first" },
//             { name: "Contact", path: "/contact" },
//             { name: "Career", path: "/career" }].map((item, index) => (
//               <Link
//                 key={index}
//                 to={item.path}
//                 className="px-4 py-2 hover:bg-[#e4a6ca] text-white rounded transition"
